...
\begin{frame}{Related literature}
  \small
  \begin{itemize}
    \item \textbf{Debt crises without default}: \citet{pescatori2007adequately}, \citet{aguiar2016quantitative}, \citet{krishnamurthy2017credit}, \citet{mitchener2021sovereign}
    \item \textbf{Fluctuations in country spreads}: \citet{uribeyue2006country}, \citet{arellano2008default}, \citet{bocola2016passthrough}, \citet{bahaj2020sovereign}
    \item \textbf{Output costs of default}: \citet{borensztein2009costs}, \citet{furceri2012costly}, \citet{trebesch2017output}, \citet{kuvshinov2019sovereigns}, \citet{asonuma2024costs}
    \item \textbf{Sovereign-bank nexus}: \citet{gennaioli2014sovereign}, \citet{gennaioli2018banks}, \citet{broner2014sovereign}, \citet{angelini2014negative}
  \end{itemize}
  \vspace{0.6em}
