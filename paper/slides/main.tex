...
\newcommand{\shortauthortext}{Betsem A Djam (HEC Paris)}
...
\title{\large\bfseries Costs of Sovereign Debt Crises With and Without Default:\\
Effect of the Sovereign-Bank Nexus}
\author{\normalsize David Betsem A Djam\textsuperscript{a}}
\institute{%
  \footnotesize
  \textsuperscript{a}~HEC Paris, Institut Polytechnique de Paris
}
...
\begin{frame}[plain]
  \vspace{1cm}
  \begin{center}
    \usebeamercolor[fg]{title}{\Large\bfseries Costs of Sovereign Debt Crises With and\\
    Without Default: Effect of the Sovereign-Bank Nexus\par}
  \end{center}
  \vspace{1cm}
  \begin{center}
    \large David Betsem A Djam\textsuperscript{a}\par
    \vspace{0.6em}
    \small \textsuperscript{a}~HEC Paris, Institut Polytechnique de Paris\par
  \end{center}
  \vspace{1.5cm}
  \begin{center}
  ...
  \end{center}
  \vfill
  {\tiny\itshape The views expressed in this presentation are those of the author
  and do not necessarily represent those of HEC Paris or Institut Polytechnique
  de Paris.\par}
\end{frame}
}
