...
exposure, by 0.0--6.9 percentage points (95\% bootstrap CI, $h=1$).
...
nexus is associated with a significantly higher GDP on impact, by 0.0--6.9
percentage points (95\% bootstrap CI, $h=1$).
...
high-exposure countries in crises without default (by 0.0--6.9 percentage
points, 95\% bootstrap CI), with no significant difference in crises with
default.
...
on impact, by 0.0--6.9 percentage points (95\% bootstrap CI, $h=1$). This
asymmetry is consistent with the possibility
