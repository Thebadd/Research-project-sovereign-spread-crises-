...
spreads. \citet{uribeyue2006country} document, in a vector
autoregression for a panel of emerging economies, that country spreads
and output growth explain a substantial share of each other's
fluctuations, consistent with spreads acting as both a symptom and a
driver of macroeconomic distress. \citet{arellano2008default} later
develops a quantitative model that provides a theoretical mechanism for
this comovement: default risk and interest rate spreads are jointly
determined by the state of the economy, default becomes more attractive
in recessions since repaying non-contingent debt is costlier for a
risk-averse borrower when income is low, and lenders price this rising
default risk into spreads before any default is realized. Together,
these two papers provide the basis for treating elevated spreads as
informative of sovereign distress on their own, independently of
whether a formal default follows. \citet{bocola2016passthrough}
shows theoretically that the mere expectation of a future default,
transmitted through domestic banks' balance sheets, can tighten credit
conditions and depress output even when no default is ultimately
realized. This literature, taken as a whole, motivates identifying episodes of
sovereign distress directly from spread behavior rather than from
realized default, the approach this paper follows to define spread
crises with and without default.
...
estimate this cost using cross-country panels, typically finding losses
of 1--4 percentage points of GDP per capita growth around default
episodes, though estimates vary with the sample period, the definition
of default, and the horizon considered. \citet{levyyeyati2011elusive}
show that a substantial share of this output contraction occurs before
the default itself, during the period of rising distress that precedes
it, a finding that motivates comparing default-linked and non-default
crises within the same identification framework rather than comparing
default to tranquil years alone. Within the default-linked category
itself, \citet{asonuma2024costs} show that these costs vary
systematically with the resolution strategy chosen, with post-default
restructurings markedly more costly than preemptive ones negotiated
before a missed payment. Our analysis considers a broader distinction
that operates one level up from restructuring strategy, asking instead
whether crises that culminate in sovereign default carry different
macroeconomic costs than crises of comparable severity that do not end
in default.
