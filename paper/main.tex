...
default-linked crises (about 7 pp, significant), against a small,
not significant decline for non-default crises -- the only gap in the
paper significant under both tests, and under the bootstrap test only
at this horizon. The increase then fades and turns negative by $h=5$
