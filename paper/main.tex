...
non-default onsets rather than against tranquil years. Evaluated at the
sample means of the two groups, the model in column (1) implies a
...
resolution, consistent with more open economies being more exposed to
...
resolution, consistent with greater capacity to absorb the shock
through domestic financial intermediation rather than external
restructuring -- the same channel underlying the sovereign-bank nexus
results in Section~\ref{sec:nexus}. A sharper nominal depreciation is
associated with a higher likelihood of default-linked resolution, in
line with a balance-sheet channel through which currency depreciation
raises the local-currency burden of foreign-currency debt service.
Lower pre-crisis inflation is likewise associated with a higher
likelihood of default-linked resolution, consistent with inflation
acting as a competing adjustment margin that, where available, erodes
the real value of domestic-currency debt and reduces the need for
outright default. GDP growth, the public debt-to-GDP ratio, the banking
