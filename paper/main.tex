...
default-linked crises, by about 7 pp, compared with a small decline of
less than 1 pp following non-default crises. This is the only outcome
for which the difference between crisis types is significant under both
tests, with the bootstrap difference significant only at $h=1$. The
increase in claims following default-linked crises subsequently fades
and turns negative by $h=5$, reaching about $-$3 pp compared with
near-zero effects following non-default crises. However, this later
