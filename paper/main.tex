...
whose 95\% bootstrap CI, [0.0,6.9], excludes zero.
...
exposure is high, a difference that is not statistically significant at
any horizon. For crises without default, by contrast, a higher pre-crisis
...
difference whose 95\% bootstrap CI, [0.0,6.9], excludes zero.
...
percentage points at $h=1$; 95\% bootstrap CI on the difference,
[0.0,6.9]), with no significant difference in crises with default.
...
low-exposure countries), a difference whose 95\% bootstrap CI, [0.0,6.9],
excludes zero. This asymmetry is consistent with the possibility
