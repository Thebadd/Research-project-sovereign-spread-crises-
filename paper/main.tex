...
\newcommand{\notes}[1]{\par\vspace{4pt}\footnotesize\noindent\textit{Notes:} #1\par}
\newcommand{\source}[1]{\par\vspace{2pt}\footnotesize\noindent\textit{Source:} #1\par}
...
This paper contributes to the literature in three main respects. First, we
contribute to the literature on debt crises without default by providing a
cross-country assessment of their macroeconomic effects. Bocola (2016)
shows theoretically that expectations of future default can tighten bank
lending and depress output. Mitchener and Trebesch (2021) document that
such episodes have become increasingly common since the 1990s. Neither
this work, nor the broader literature that defines these episodes through
bond-market distress (Pescatori and Sy, 2007; Aguiar et al., 2016;
Krishnamurthy and Muir, 2017), offers systematic evidence on their
aggregate output effects.

Second, we contribute to the literature on the output cost of sovereign
default by comparing crises with and without default within the same
estimation framework. Existing estimates of this cost typically range from
1 to 4 percentage points of GDP per capita growth (Borensztein and
Panizza, 2009; Furceri and Zdzienicka, 2012; Trebesch and Zabel, 2017;
Kuvshinov and Zimmermann, 2019). These estimates are generally not
benchmarked against a comparable sample of equally severe episodes that
did not end in default. This limits their ability to isolate the cost of
the default event itself from the cost of the underlying distress, a
distinction raised by Levy Yeyati and Panizza (2011), who find that most
output contraction occurs before the default. Our estimates indicate that
GDP and bank credit to the private sector fall considerably more, and for
longer, in default-linked crises than in crises without default.
Investment declines by a broadly similar magnitude across both. The
response of FDI and real lending rates does not differ significantly at
any horizon. This pattern is consistent with an additional output and
credit cost specific to default itself. It points more toward the direct
legal and negotiation costs of default, such as haircuts, coercive terms,
and credit-market exclusion, than toward investment or external financing
channels. The relatively small number of default-linked episodes in our
sample warrants caution in drawing a sharp causal distinction.

Third, we contribute to the sovereign-bank nexus literature by examining
whether pre-crisis bank exposure to the sovereign is associated with
different macroeconomic responses across crisis types. This literature is
largely built on euro-area or single-country microdata (Gennaioli,
Martin, and Rossi, 2014; Bocola, 2016; Acharya, Eisert, Eufinger, and
Hirsch, 2018). It emphasizes bank holdings of sovereign debt as a channel
through which sovereign distress transmits to credit and output. We
measure exposure using the pre-crisis share of bank assets held as claims
on government, rather than the credit-to-GDP measure used by Gennaioli,
Martin, and Rossi (2014) and Asonuma, Chamon, Erce, and Sasahara (2024).
We find that claims on government rise sharply in the crisis year
following default-linked crises, but not following crises without
default. This pattern is consistent with the balance-sheet channel and
with evidence that banks continue to absorb sovereign risk during
distress rather than shed it (Acharya and Steffen, 2015; Acharya,
Drechsler, and Schnabl, 2014). For default-linked crises, higher
pre-crisis exposure is associated with a more negative GDP response,
though the difference is not statistically significant. For crises
without default, higher exposure is associated with a significantly
better GDP response on impact. This result may suggest a stabilizing role
for a domestic banking sector heavily exposed to the sovereign when no
default occurs.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image01.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image02.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/docx_image03.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image04.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{figures/docx_image05.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image06.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image07.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image08.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image09.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image10.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/docx_image11.png}
...
\begin{table}[p]
\centering
\caption{Estimation results, OLS (Table C1)}
\label{tab:C1}
\footnotesize
\begin{tabular}{lccccc}
\toprule
...
\begin{table}[htbp]
\centering
\caption{Regression of each type of spread crisis on control variables (Table D1)}
\label{tab:D1}
\footnotesize
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/docx_image12.png}
