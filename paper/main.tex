...
between non-default and default-linked crises. GDP declines by around
1--2 percentage points (pp) following non-default crises, compared with
4--9 pp following default-linked crises; the difference is significant
under the bootstrap test at $h=1$ and $h=2$, but not thereafter. Bank
credit turns significantly positive by $h=5$ following non-default
crises, reaching nearly 7 pp above its pre-crisis path, but falls by
more than 40 pp following default-linked crises, with the difference
significant from $h=2$ onward. Second, the distinction is less
pronounced for investment, FDI, and real lending rates. Investment
declines by 5--14 pp following non-default crises and by 9--18 pp
following default-linked crises, while FDI and real lending rates are
smaller and more volatile, switching sign across horizons. None of these
outcomes differs significantly between crisis types under the bootstrap
test at any horizon. Third, claims on the government rise sharply at
$h=1$ following default-linked crises, by around 7 pp, compared with a
small decline following non-default crises. This is the only outcome for
which the difference between crisis types is significant under both
tests, with the bootstrap difference significant only at $h=1$. The
increase in government claims subsequently fades and turns negative by
$h=5$, at around $-3$ pp, although this reversal is not significant
under the bootstrap test. Finally, the pre-crisis sovereign-bank nexus
does not systematically amplify the output costs of default-linked
crises: GDP falls by around 18 pp in high-nexus countries versus 8 pp in
low-nexus countries at $h=1$, but the difference is not significant
under the bootstrap test. For non-default crises, by contrast, a higher
pre-crisis nexus is associated with a significantly smaller decline in
GDP on impact, with effects of around 1 pp and $-3$ pp for high- and
low-nexus countries, respectively, at $h=1$.
