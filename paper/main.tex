...
default, GDP declines modestly but significantly, by around 1--2
percentage points over the first two years, before returning towards its
pre-crisis path and losing statistical significance from year 3 onward.
By contrast, GDP falls by 6--9 percentage points following crises with
...
path following crises with default, a contraction that remains
persistent through the end of the horizon. Second, this distinction is less
apparent for investment, FDI, and real lending rates: none of the three
differ significantly between crisis types under the bootstrap test at
any horizon, although the Clogg et al.\ (1995) companion test indicates
significant differences for each of them at some horizons. Third, claims on
