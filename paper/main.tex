...
\textbf{First, several structural characteristics predict whether a
sovereign spread crisis culminates in default.} A more severe initial
spread shock, greater trade openness, and larger currency depreciation
are each associated with a higher likelihood of default, while a
deeper domestic banking sector and higher pre-crisis inflation are
associated with a lower likelihood, consistent with these offering
...
\textbf{Third, investment, FDI and real lending rates show no
significant differences between crisis types.} All three move
significantly following at least one crisis type, but the difference
between non-default and default-linked crises is never significant
