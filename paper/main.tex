...
from $h=3$ onward. By contrast, GDP falls by 4--9 pp following
...
crises, by contrast, credit falls to more than 40 pp below its
pre-crisis path, with the contraction remaining persistent throughout
the horizon. The difference between the two crisis types is significant
under the bootstrap test from $h=2$ onward, but not in the crisis year
($h=1$).
...
declines statistically significant at every horizon. FDI and real
lending rates are smaller and more volatile, switching sign across
horizons for both crisis types. For all three outcomes, the difference
between crisis types is not significant under the bootstrap test at any
horizon.

Third, claims on the government rise sharply at $h=1$ following
default-linked crises, by about 7 pp, and this increase is statistically
significant. This contrasts with a small but also significant decline
of less than 1 pp following non-default crises. This is the only
outcome for which the difference between crisis types is significant
under both tests, with the bootstrap difference significant only at
$h=1$. The increase in government claims subsequently fades and turns
negative by $h=5$, reaching about $-$3 pp compared with near-zero
effects following non-default crises. However, this reversal is not
significant under the bootstrap test at any horizon beyond $h=1$. Thus,
the results do not allow us to establish whether default-linked crises
ultimately lead to greater or smaller bank exposure to the sovereign
than non-default crises.
...
low-nexus group, but the difference is not significant under the
bootstrap test at this or any other horizon. For non-default crises, by
contrast, a higher pre-crisis nexus is associated with a significantly
smaller decline in GDP on impact: GDP changes by around 1 pp in the
high-nexus group, compared with about $-$3 pp in the low-nexus group at
$h=1$. This difference is significant under the bootstrap test.
