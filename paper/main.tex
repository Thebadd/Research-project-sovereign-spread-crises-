...
spreads. \citet{arellano2008default} develops a quantitative model in
which default risk and interest rate spreads are jointly determined by
the state of the economy: default becomes more attractive in recessions,
since repaying non-contingent debt is costlier for a risk-averse
borrower when income is low, and lenders price this rising default risk
into spreads before any default is realized. This provides the
theoretical basis for treating elevated spreads as informative of
sovereign distress on their own, independently of whether a formal
default follows. \citet{uribeyue2006country} confirm this empirically for
a panel of emerging economies, showing in a vector autoregression that
country spreads and output growth explain a substantial share of each
other's fluctuations, consistent with spreads acting as both a symptom
and a driver of macroeconomic distress. \citet{bocola2016passthrough}
...
realized. Together, this literature motivates identifying episodes of
