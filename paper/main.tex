...
sample means of the two groups, the model in column (1) of
Table~\ref{tab:spreadintensity} implies a
...
Column (2) points to a coherent set of economic mechanisms behind this
...
\begin{tabular}{lcc}
\toprule
\multicolumn{3}{l}{Dependent variable = Dummy taking 1 if the onset resolves as default-linked} \\
\midrule
 & (1) & (2) \\
\midrule
Peak EMBIG spread at onset & 0.001*** & 0.001*** \\
 & (0.000) & (0.000) \\[4pt]
GDP growth & & $-$15.945 \\
 & & (11.089) \\[2pt]
