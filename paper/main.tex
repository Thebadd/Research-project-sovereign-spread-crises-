...
bootstrap test from $h=2$ onward, but not at $h=1$ itself.
...
Third, claims on the government increase sharply at $h=1$ following
default-linked crises, by around 7 pp, while remaining broadly unchanged
following non-default crises. The difference between the two crisis
types is significant under the bootstrap test only at $h=1$.
