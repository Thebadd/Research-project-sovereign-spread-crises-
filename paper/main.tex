...
default. Empirically, spread crises without default are more strongly
associated with external market conditions, while spread crises with
default are more strongly associated with domestic conditions. One
interpretation is that non-default crises may primarily reflect
temporary refinancing pressures, whereas default-linked crises may
reflect more fundamental debt-sustainability problems. In the former
case, avoiding default may allow the sovereign to preserve market
access and benefit from a recovery in investor confidence. In the
latter, delaying restructuring may prolong uncertainty and elevated
financing costs without resolving the underlying debt problem. We also
find that a deeper domestic banking sector is associated with a lower
likelihood of default in the first place: where domestic financial
intermediation is deeper, the economy can draw more on domestic
financing and preserve debt servicing through alternative adjustment
margins, such as inflation or financial repression, rather than through
default.
...
weakening balance sheets and constraining private-sector credit.
Consistent with an anticipation effect, we find that bank claims on
government rise sharply in the year a default-linked crisis begins,
suggesting that banks increase their reliance on the domestic sovereign
market in anticipation of future exclusion from external financing
after the default.
