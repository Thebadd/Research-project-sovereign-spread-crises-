...
between crises with and without default. GDP declines by around 1--2
percentage points (pp) following non-default crises, against 4--9 pp
following default-linked crises, a gap significant under the bootstrap
test at $h=1,2$ but not thereafter. Bank credit turns significantly
positive by $h=5$ following non-default crises (nearly 7 pp) but falls
by more than 40 pp following default-linked crises, a gap significant
under the bootstrap test from $h=2$ onward.
...
crises and by 9--18 pp following default-linked crises; FDI and real
lending rates are smaller and volatile, switching sign across horizons.
None of the three differ significantly between crisis types under the
bootstrap test at any horizon.

Third, claims on the government rise sharply at $h=1$ following
default-linked crises (about 7 pp), against a small decline for
non-default crises -- the only gap in the paper significant under both
tests, and under the bootstrap test only at this horizon. The increase
fades and turns negative by $h=5$ (about $-$3 pp), but this reversal is
not significant under the bootstrap test, so the paper cannot establish
whether default-linked crises end with more or less bank exposure to
the sovereign than non-default crises.

Finally, the pre-crisis sovereign-bank nexus does not systematically
amplify the output costs of default-linked crises (around 18 vs.\ 8 pp
at $h=1$, not significant under the bootstrap test). For non-default
crises, by contrast, a higher pre-crisis nexus is associated with a
significantly smaller decline in GDP on impact (around 1 vs.\ $-$3 pp
at $h=1$), significant under the bootstrap test.
