...
more dispersion. Peak spread intensity remains a positive and
significant predictor of default-linked resolution in
Table~\ref{tab:spreadintensity}, even once the baseline controls are
added, and the table points to a coherent set of economic mechanisms
behind this gap more broadly, rather than an isolated statistical
association. Higher trade
