...
($h=1$) following default-linked crises, by around 7 pp, while remaining
broadly unchanged following non-default crises. The difference between
the two crisis types is significant under the bootstrap test only in the
crisis year ($h=1$).
