...
following crises without default. Finally, the pre-crisis
sovereign-bank nexus shows that, for debt crises without default, a
higher nexus is associated with a significantly better GDP response
on impact, while for default-linked crises, the impact is worse for
high-nexus countries, even though we have not been able to establish
a statistically significant difference between high- and low-nexus
countries.
