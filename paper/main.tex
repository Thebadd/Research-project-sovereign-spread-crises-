...
Second, this paper relates to the literature on fluctuation in country
spreads. \citet{arellano2008default} shows theoretically that default
...
a large share of the other's fluctuations. \citet{bocola2016passthrough}
shows theoretically that expectations of a future default can tighten
bank lending and depress output even absent an actual default.
...
estimate this cost at 1--4 percentage points of GDP per capita growth.
Recent work shows that these costs vary across episodes; \citet{asonuma2024costs} find that post-default restructurings are markedly
more costly than preemptive ones. Our analysis considers a broader
distinction, asking whether crises that culminate in sovereign default
have different macroeconomic costs from crises without default. This
comparison is motivated by \citet{levyyeyati2011elusive}, who show that
a substantial share of the output contraction associated with sovereign
default occurs before the default itself.
