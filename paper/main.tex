...
First, several structural characteristics predict whether a sovereign
spread crisis culminates in default. A more severe initial spread
shock, greater trade openness, and larger currency depreciation are
each associated with a higher likelihood of default, while a deeper
domestic banking sector and higher pre-crisis inflation are associated
with a lower likelihood, suggesting that domestic financial
intermediation and inflation may provide alternative adjustment
margins.

Second, GDP and bank credit to the private sector exhibit the clearest
and most persistent differences between our two types of crises.
Following crises without default, GDP declines modestly, by around
1--2 percentage points (pp) over the first two years, a decline that
is itself statistically significant, before returning towards its
pre-crisis path. By contrast, GDP falls by 4--9 pp following crises
with default, with the decline remaining significant five years after
the crisis onset. Bank credit displays a similar, but more delayed,
contrast: it turns significantly positive by the fifth year following
crises without default, reaching nearly 7 pp above its pre-crisis
path, while falling to more than 40 pp below its pre-crisis path
following crises with default, a contraction that remains persistent
through the end of the horizon.

Third, investment, FDI and real lending rates show no significant
differences between crisis types. All three move significantly
following at least one crisis type, but the difference between
non-default and default-linked crises is never significant under the
bootstrap test.

Fourth, the composition of bank balance sheets also differs across
crisis types. Bank claims on the government increase significantly by
approximately 7 pp at $h=1$ following default-linked crises, whereas
they decline by less than 1 pp following non-default crises. This
difference is statistically significant under the bootstrap test,
pointing to a distinct short-run response of banks' sovereign
exposures across the two types of crisis.

Fifth, we find no systematic evidence that a stronger pre-crisis
sovereign-bank nexus amplifies the output costs of default-linked
crises. At $h=1$, GDP declines by approximately 18 pp in the
high-nexus group, compared with around 8 pp in the low-nexus group.
However, this difference is not statistically significant under the
bootstrap test at any horizon. For non-default crises, by contrast, a
stronger pre-crisis nexus is associated with a significantly smaller
decline in GDP on impact: GDP changes by approximately 1 pp in the
high-nexus group, compared with a decline of around 3 pp in the
low-nexus group. This difference is statistically significant under
the bootstrap test.
