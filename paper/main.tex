...
default, GDP declines modestly, by around 1--2 percentage points over
the first two years -- a decline that is itself significant, though it
fades from year 3 onward -- while following crises with default, GDP
falls by 6--9 percentage points, remaining significant through year 5.
The difference between the two crisis types is significant under the
bootstrap test during the first two years, but not thereafter. Bank
credit displays a similar, but more delayed, contrast: it turns
significantly positive by the fifth year following crises without
default, reaching nearly 7 percentage points above its pre-crisis path,
while falling to almost 40 percentage points below its pre-crisis path
following crises with default, a contraction that remains persistent
through the end of the horizon. The difference between the two crisis
types is significant under the bootstrap test from year 2 onward, though
not in the crisis year itself. Second, this distinction is less apparent for investment, FDI, and real
...
default-linked crises, both declines significant at every horizon; FDI
and the real lending rate move by comparatively small and inconsistently
signed amounts in both crisis types. For all three outcomes, the
difference between crisis types is not significant under the bootstrap
test at any horizon. Third, claims on
...
following crises without default; the difference between the two crisis
types is significant under the bootstrap test only in that crisis year.
Finally, the pre-crisis sovereign-bank
nexus does not systematically amplify the output costs of crises with
default: at $h=1$, GDP falls by 17.85 percentage points in the
high-nexus group against 7.72 in the low-nexus group, a gap that is not
significant under the bootstrap test at this or any other horizon. For
crises without default, by contrast, a higher pre-crisis
nexus is associated with a significantly higher GDP on impact (0.75 vs.\
$-$2.87 percentage points at $h=1$ for high- vs.\ low-nexus countries), a
difference that is significant under the bootstrap test.
