...
GDP declines modestly, by around 1--2 percentage points over $h=1$--2.
Although this decline is statistically significant, it fades from
$h=3$ onward. By contrast, GDP falls by 4--9 percentage points
following default-linked crises and remains significantly below its
pre-crisis path through $h=5$. The difference between the two crisis
types is significant under the bootstrap test at $h=1$--2, but not
thereafter. Bank credit shows a similar, though more delayed, pattern.
Following non-default crises, credit becomes significantly positive by
$h=5$, reaching nearly 7 percentage points above its pre-crisis path.
Following default-linked crises, by contrast, credit falls to more than
40 percentage points below its pre-crisis path, with the contraction
remaining persistent throughout the horizon. The difference between the
two crisis types is significant under the bootstrap test from $h=2$
onward, but not in the crisis year ($h=1$).
