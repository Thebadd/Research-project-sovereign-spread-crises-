...
\citet{pescatori2007adequately} argue that a default-only definition of debt
...
\citet{broner2013why} and \citet{aguiar2016quantitative}, who
...
spikes'' by \citet{krishnamurthy2017credit}. \citet{mitchener2021sovereign}
...
exposure is high. For crises without default, by contrast, a higher
pre-crisis nexus is associated with a significantly better GDP response
on impact.
...
The first is the literature on debt crises without default. \citet{pescatori2007adequately}, \citet{aguiar2016quantitative}, and \citet{krishnamurthy2017credit} define
these episodes through bond-market distress rather than through a missed
payment. \citet{bocola2016passthrough} shows theoretically that expectations of a future
...
severe episodes that did not end in default. \citet{arellano2008default}
develops a quantitative sovereign default model in which default
probabilities and interest rate spreads are jointly determined: default
is more likely in recessions, since repaying non-contingent debt is
costlier for a risk-averse borrower when income is low, and lenders
price this rising default risk into the countercyclical spreads the
model generates. Spreads in this framework are the market price of
default risk itself, which is why this paper treats elevated spreads as
informative of sovereign distress independently of whether a formal
default is ultimately realized. \citet{levyyeyati2011elusive} show that most output contraction occurs before the default
...
within a single one, and find a significantly better GDP response to high
exposure in crises without default, with no significant difference in
crises with default.
...
\hline
Systemic banking crisis dummy & \citet{laeven2013systemic,laeven2020systemic} \\
\hline
