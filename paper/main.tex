...
GDP declines modestly, by around 1--2 percentage points over the first
two years. Although this decline is statistically significant, it fades
from year 3 onward. By contrast, GDP falls by 6--9 percentage points
following default-linked crises and remains significantly below its
pre-crisis path through year 5. The difference between the two crisis
types is significant under the bootstrap test during the first two
years, but not thereafter. Bank credit shows a similar, though more
delayed, pattern. Following non-default crises, credit becomes
significantly positive by year 5, reaching nearly 7 percentage points
above its pre-crisis path. Following default-linked crises, by contrast,
credit falls to almost 40 percentage points below its pre-crisis path,
with the contraction remaining persistent throughout the horizon. The
difference between the two crisis types is significant under the
bootstrap test from year 2 onward, but not in the crisis year itself.
...
following default-linked crises, by around 7 percentage points, while
remaining broadly unchanged following non-default crises. The difference
between the two crisis types is significant under the bootstrap test
only in the crisis year.
...
by 17.85 percentage points in the high-nexus group, compared with 7.72
percentage points in the low-nexus group, but the difference is not
...
0.75 percentage points in the high-nexus group, compared with $-$2.87
percentage points in the low-nexus group at $h=1$. This difference is
