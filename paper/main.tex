...
GDP declines modestly, by around 1--2 percentage points (pp) over
$h=1$--2. Although this decline is statistically significant, it fades
from $h=3$ onward. By contrast, GDP falls by 6--9 pp following
default-linked crises and remains significantly below its pre-crisis
path through $h=5$. The difference between the two crisis types is
significant under the bootstrap test at $h=1$--2, but not thereafter.
Bank credit shows a similar, though more delayed, pattern. Following
non-default crises, credit becomes significantly positive by $h=5$,
reaching nearly 7 pp above its pre-crisis path. Following default-linked
crises, by contrast, credit falls to almost 40 pp below its pre-crisis
path, with the contraction remaining persistent throughout the horizon.
The difference between the two crisis types is significant under the
bootstrap test from $h=2$ onward, but not in the crisis year ($h=1$)
itself.

Second, the distinction is less pronounced for investment, FDI, and real
lending rates. Investment declines by 5--14 pp following non-default
crises and by 9--18 pp following default-linked crises, with both
declines statistically significant at
...
Third, claims on the government increase sharply in the crisis year
($h=1$) following default-linked crises (6.67 pp, itself significant),
while displaying a small, not significant decline following non-default
crises ($-$0.71 pp). This is the only gap in the paper that survives
under both the bootstrap and the Clogg et al.\ (1995) tests, and the
difference between the two crisis types is significant under the
bootstrap test only in this crisis year. The initial increase in
default-linked crises then fades and eventually turns negative by
$h=5$ ($-$2.61 pp, against $-$0.38 pp for non-default crises), so
claims on government are estimated to be lower for default-linked
crises than for non-default crises by the end of the horizon. This
later-horizon reversal is not statistically significant under the
bootstrap test, however, which does not reject equality of the two
coefficients at any horizon beyond $h=1$; the paper therefore does not
establish whether default-linked crises end with more or less bank
exposure to the sovereign than non-default crises.
...
by around 18 pp in the high-nexus group, compared with about 8 pp in the
low-nexus group, but the difference is not
significant under the bootstrap test at this or any other horizon. For
non-default crises, by contrast, a higher pre-crisis nexus is associated
with a significantly smaller decline in GDP on impact: GDP changes by
around 1 pp in the high-nexus group, compared with about $-$3 pp in the
low-nexus group at $h=1$. This difference is
significant under the bootstrap test.

\noindent\textbf{Related literature:}\par
This paper relates to three strands of
the literature on sovereign debt.

The first is the literature on debt crises without default. \citet{pescatori2007adequately} define these episodes through bond-market
distress rather than through a missed payment, extending the definition
of debt crises to episodes in which yield spreads exceed 1000 basis
points, a threshold they describe as a ``psychological barrier'' for
market participants; \citet{broner2013why}, \citet{aguiar2016quantitative}, and \citet{krishnamurthy2017credit} adopt a
similar bond-market-based approach, the latter terming such episodes
``spread crises'' or ``spread spikes.''
\citet{arellano2008default} shows theoretically that default
risk and interest rate spreads are jointly determined by the state of
the economy, with spreads rising before any default occurs -- the basis
for treating elevated spreads as informative of sovereign distress on
their own. \citet{uribeyue2006country} confirm this empirically: country
spreads and output move together in emerging economies, each explaining
a large share of the other's fluctuations. \citet{bocola2016passthrough} shows theoretically that expectations of a future
default can tighten bank lending and depress output even absent an actual
default. \citet{mitchener2021sovereign} document that such episodes have
...
severe episodes that did not end in default. \citet{levyyeyati2011elusive} show that most output contraction occurs before the default
...
comparing default to tranquil years alone. Within the default-linked
category itself, \citet{asonuma2024costs} show that output costs vary
systematically with the restructuring strategy chosen, post-default
resolutions being markedly more costly than preemptive ones; our
comparison operates one level up from that distinction, contrasting
default-linked crises as a whole against crises that do not end in
default. We build on this work by
...
lending rates do not differ significantly across the two under the
bootstrap test.

Third, this paper relates to the sovereign-bank nexus literature, which
is built largely on euro-area or single-country microdata.
\citet{gennaioli2014sovereign} and \citet{acharya2018real} emphasize bank
holdings of sovereign debt as a channel through which sovereign distress
transmits to credit and output, \citet{dellariccia2018managing} describe
the resulting adverse feedback loops between bank and sovereign distress,
and \citet{broner2014sovereign} document a crowding-out effect on credit
to the private sector even absent a default. \citet{acharya2015greatest}
show that eurozone banks increased rather than reduced their holdings of
domestic sovereign debt as sovereign risk rose, a ``carry trade''
sustained by funding advantages tied to the sovereign's own credit
standing, and \citet{acharya2014pyrrhic} show that bank bailouts
themselves raised sovereign credit risk, which then fed back onto the
banks holding that debt: both document a channel that runs through banks
absorbing sovereign risk rather than shedding it, and \citet{copestake2023banks}
show that this exposure can also generate direct capital losses for banks
when interest rates rise. This is consistent with our finding that claims
on government rise sharply in the crisis year following default-linked
crises but not following crises without default. The relevance of this
channel has only grown in recent years: \citet{deghi2022sovereign} and
\citet{wezel2026sovereign} document a marked strengthening of the
sovereign-bank nexus across emerging and developing economies since the
COVID-19 pandemic, driven by rising public debt and greater reliance on
domestic banks for financing. We extend this literature by comparing
high- and low-exposure countries across both crisis types rather than
within a single one, and find a significantly higher GDP on impact for
high-exposure countries in crises without default (0.75 vs.\ $-$2.87
percentage points at $h=1$, significant under the bootstrap test), with
no significant difference under the bootstrap test in crises with
default.
...
sovereign-bank channel discussed above, in which banks that avoid
absorbing losses on defaulted debt are better placed to keep lending. Our
design does not allow us to adjudicate between these explanations. A
related question is whether avoiding default is unambiguously
preferable once spreads have already risen sharply, or whether
non-default resolution simply postpones costs that default would
otherwise crystallize sooner. Our evidence on this point is limited: as
discussed in Section 4.2, the increase in bank claims on government
following default-linked crises is a robust finding only in the crisis
year, and we cannot establish whether default-linked crises leave banks
more or less exposed to the sovereign in the long run than crises
resolved without default. We therefore do not read our results as
evidence that avoiding default is costless, nor that it merely defers
distress; both readings remain open. Finally, our design does not
control for the intensity of the initial spread spike, so part of the
contrast between crisis types could reflect that more severe spread
episodes are more likely to end in default, rather than default itself
driving the difference in outcomes; disentangling the severity of the
initiating shock from the resolution strategy chosen is a natural
