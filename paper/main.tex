...
GDP declines modestly, by around 1--2 percentage points (pp) over the
first two years. Although this decline is statistically significant, it
fades from year 3 onward. By contrast, GDP falls by 6--9 pp following
default-linked crises and remains significantly below its pre-crisis
path through year 5. The difference between the two crisis types is
significant under the bootstrap test during the first two years, but not
...
year 5, reaching nearly 7 pp above its pre-crisis path. Following
default-linked crises, by contrast, credit falls to almost 40 pp below
its pre-crisis path,
...
following default-linked crises, by around 7 pp, while remaining broadly
unchanged following non-default crises. The difference
...
by 17.85 pp in the high-nexus group, compared with 7.72 pp in the
...
0.75 pp in the high-nexus group, compared with $-$2.87 pp in the
