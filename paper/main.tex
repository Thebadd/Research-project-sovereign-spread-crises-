...
clearest and most persistent differences between our two types of
crises.} Following crises without default, GDP declines modestly, by
around 1--2 percentage points over the first two years, a decline that
is itself statistically significant, before returning towards its
pre-crisis path. By contrast, GDP falls by 4--9 percentage points
following crises with default, with the decline remaining significant
five years after the crisis onset. Bank credit displays a similar, but
more delayed, contrast: it turns significantly positive by the fifth
year following crises without default, reaching nearly 7 percentage
points above its pre-crisis path, while falling to more than 40
percentage points below its pre-crisis path following crises with
default, a contraction that remains persistent through the end of the
horizon.
