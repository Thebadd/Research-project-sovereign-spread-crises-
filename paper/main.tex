...
\captionsetup{font=it, justification=justified, singlelinecheck=false}
...
\setlength{\textfloatsep}{10pt plus 2pt minus 2pt} % gap between two stacked top floats (e.g. a table followed by a figure)
\setlength{\intextsep}{10pt plus 2pt minus 2pt}     % gap around an in-text (non-top) float
...
\newcommand{\notes}[1]{\par\vspace{8pt}\footnotesize\itshape\justifying\noindent Notes: #1\par\vspace{2pt}}
\newcommand{\source}[1]{\par\vspace{4pt}\footnotesize\itshape\justifying\noindent Source: #1\par\vspace{2pt}}
