...
Our results yield five main findings.

\textbf{First, we identify several structural characteristics
associated with the likelihood that a sovereign spread crisis
culminates in default.} The peak intensity of the spread shock during
the crisis-onset year is a strong predictor of default, indicating that
more severe market shocks are more likely to be accompanied by default.
Greater trade openness and larger currency depreciation are also
associated with a higher likelihood of default, consistent with the
role of balance-of-payments pressures. By contrast, a deeper domestic
banking sector and higher pre-crisis inflation are associated with a
lower likelihood of default, suggesting that domestic financial
intermediation and inflation may provide alternative adjustment
margins.

\textbf{Second, GDP and bank credit to the private sector exhibit the
clearest and most persistent differences between crises with and
without default.} Following non-default crises, GDP declines by around
1--2 percentage points over $h=1$--2, before the decline fades.
Following default-linked crises, GDP falls by 4--9 percentage points
and remains significantly below its pre-crisis path throughout the
five-year horizon. The difference between the two crisis types is
statistically significant under the bootstrap test at $h=1$--2.
Private-sector credit displays an even more pronounced divergence.
Following non-default crises, credit initially declines by 1--3
percentage points but subsequently recovers, becoming significantly
positive at $h=4$--5 and reaching nearly 7 percentage points by the end
of the horizon. Following default-linked crises, credit contracts
significantly from $h=2$--5, with declines of approximately 23--42
percentage points. The difference between the two crisis types is
statistically significant under the bootstrap test over this latter
period.

\textbf{Third, we find no significant differences between crisis types
for investment, FDI and real lending rates.} Although these variables
exhibit statistically significant movements following at least one type
of crisis, we find no statistically significant differences between
their responses to crises with and without default under the bootstrap
test at any horizon. Thus, the divergence in macroeconomic outcomes is
concentrated in GDP and private-sector credit, and is absent for these
other variables.

\textbf{Fourth, the composition of bank balance sheets also differs
across crisis types.} Bank claims on the government increase
significantly by approximately 7 percentage points at $h=1$ following
default-linked crises, whereas they decline by less than 1 percentage
point following non-default crises. This difference is statistically
significant under the bootstrap test, pointing to a distinct short-run
response of banks' sovereign exposures across the two types of crisis.

\textbf{Fifth, we find no systematic evidence that a stronger
pre-crisis sovereign-bank nexus amplifies the output costs of
default-linked crises.} At $h=1$, GDP declines by approximately 18
percentage points in the high-nexus group, compared with around 8
percentage points in the low-nexus group. However, this difference is
not statistically significant under the bootstrap test at any horizon.
For non-default crises, by contrast, a stronger pre-crisis nexus is
associated with a significantly smaller decline in GDP on impact: GDP
changes by approximately 1 percentage point in the high-nexus group,
compared with a decline of around 3 percentage points in the low-nexus
group. This difference is statistically significant under the
bootstrap test.

\noindent\textbf{Implications:} Our results suggest that whether a
sovereign crisis leads to default is related to both the nature of the
initial shock and the costs associated with continued debt servicing
versus default. This trade-off is emphasized by
\citet{corsetti2013sovereign} in the context of sovereign risk and
fiscal policy. Empirically, non-default crises are more strongly
associated with external market conditions, while default-linked
crises are associated with a combination of larger spread shocks and
several domestic characteristics. One possible interpretation is that
non-default crises may reflect temporary refinancing pressures,
whereas default-linked crises may involve more persistent constraints
on debt servicing. In the former case, avoiding default may allow the
sovereign to preserve market access and benefit from a recovery in
investor confidence. In the latter, delaying restructuring may prolong
uncertainty and elevated financing costs without resolving the
underlying constraints. We also find that a deeper domestic banking
sector is associated with a lower likelihood of default, consistent
with greater access to domestic financing and a wider set of
adjustment margins through which the sovereign can continue servicing
its debt.

These differences in crisis resolution are reflected in the subsequent
macroeconomic dynamics. Non-default crises are associated with
substantially smaller losses in GDP and domestic private-sector credit
than default-linked crises. One possible channel is that default
generates additional costs through the domestic financial system:
restructuring may impose losses on banks' sovereign exposures,
weakening bank balance sheets and constraining private-sector credit.
This mechanism is consistent with the sovereign-bank channel
emphasized in the literature, while \citet{mendozayue2012general}
highlight an additional transmission mechanism through disruptions in
access to imported working-capital financing. Consistent with a
possible anticipation effect, we also find that bank claims on the
government rise sharply in the year a default-linked crisis begins.
This may indicate that banks increase their exposure to the domestic
sovereign as external financing conditions deteriorate and the
prospect of default rises, consistent with the cross-country evidence
in \citet{gennaioli2018banks} that banks tend to increase their
government bond holdings in the run-up to sovereign default.

Investment and FDI, by contrast, do not exhibit the same differential
response. Both decline following a spread crisis, but we find no
statistically significant difference between non-default and
default-linked crises at any horizon. This suggests that, unlike GDP
and domestic private-sector credit, investment and FDI may respond
primarily to the uncertainty and financing constraints associated with
the crisis itself rather than to the additional consequences of
default. As emphasized by \citet{krugman1988financing} and
\citet{sachs1989debt}, uncertainty surrounding the future debt burden
can discourage investment through expectations of higher future
taxation, continued financing constraints, or the possibility of
restructuring, regardless of whether default ultimately occurs.
Avoiding default may therefore limit some of the additional costs
transmitted through the domestic banking system without eliminating
the broader uncertainty associated with the sovereign debt crisis.
...
the spread increase does not culminate in default. \citet{mendozayue2012general} extend Arellano's framework by
microfounding the output cost of default through an imported-inputs
channel, in which exclusion from international credit disrupts firms'
access to working-capital financing for imported intermediate goods.
\citet{corsetti2013sovereign} study a related margin, showing how
sovereign risk interacts with fiscal policy to shape macroeconomic
stability, with rising sovereign spreads amplifying the contractionary
effect of fiscal consolidation.
...
comparison of default-linked and non-default crises. A separate strand
of this literature documents a trade channel of the cost of default:
\citet{rose2005one} shows that sovereign restructuring is followed by a
significant and persistent decline in bilateral trade with creditor
countries, a cost distinct from the domestic financial channel
discussed below.
...
adverse feedback loops. \citet{gennaioli2018banks} document empirically
that banks often increase their holdings of government bonds in the
run-up to sovereign default, consistent with search for yield or moral
suasion; \citet{angelini2014negative} show that this incentive to hold
domestic sovereign debt intensifies in countries with weaker fiscal
positions, where concerns over potential default strengthen the
feedback loop between banks and the sovereign. \citet{broner2014sovereign} document a
...
In this paper, we compare the macroeconomic costs of sovereign spread
crises with and without default. We find that GDP and bank credit to
the private sector are largely unaffected following non-default
crises, but contract substantially and persistently following
default-linked crises. Investment and FDI also decline following
sovereign spread crises, but their responses do not differ
significantly between the two crisis types. Bank claims on the
government, by contrast, increase sharply in the crisis year following
default-linked crises, while they decline modestly following
non-default crises.

We also find that the characteristics of the crisis differ
systematically across the two groups. Default-linked crises are
associated with larger initial spread shocks, greater trade openness,
sharper currency depreciation, and a shallower domestic banking
sector. Because default-linked crises are systematically associated
with more severe initial shocks and different structural conditions,
the larger output and credit losses observed following these crises
cannot be interpreted entirely as the causal effect of default itself,
and part of the gap likely reflects the greater severity of the
underlying shock rather than default as such. Addressing this more
directly would require adding the intensity of the initial spread
shock as a control in the outcome equation of our AIPW estimates: this
variable cannot be added to the propensity model itself, since crisis
onset is defined by the spread crossing a threshold, which makes shock
intensity a near-mechanical predictor of onset versus tranquil years
rather than a genuine source of covariate balance; we leave this
extension for future work.

A higher pre-crisis sovereign-bank nexus is associated with a
significantly better GDP outcome on impact in crises without default,
but we find no statistically significant difference between high- and
low-exposure countries in crises with default at any horizon.

The results also suggest some possible mechanisms behind the larger
costs associated with default-linked crises. The sharp increase in
bank claims on the government during the crisis year is consistent
with greater reliance on domestic banks as the sovereign approaches
default and anticipates losing access to market financing. Together
with the large contraction in private-sector credit, this pattern is
consistent with domestic banks absorbing more sovereign debt,
potentially crowding out lending to the private sector.

Our results also show that avoiding default does not eliminate all
the costs of sovereign distress. Investment and FDI decline in both
types of crises, with no statistically significant difference between
them. For investment, this pattern is consistent with uncertainty
about the resolution of the sovereign debt crisis and the future debt
burden continuing to weigh on investment decisions. As emphasised by
\citet{krugman1988financing} and \citet{sachs1989debt}, uncertainty
about the future debt burden may discourage investment through
expectations of higher future taxation, continued financing
constraints, or potential restructuring. Similarly, the absence of a
differential FDI response may indicate that foreign investors respond
to uncertainty about the future path of sovereign debt and the
resolution of the crisis, rather than to default alone. Thus, avoiding
default may limit some of the immediate costs associated with
restructuring without fully resolving uncertainty about the
sovereign's future adjustment. These mechanisms are interpretations of
the observed patterns rather than channels directly identified by our
estimates.

Finally, our findings leave open an important question: does avoiding
default represent a durable resolution of sovereign distress, or does
it simply postpone the necessary adjustment? Two suggestive patterns
point to the possibility of continued adjustment. Bank claims on
government rise in the crisis year following default-linked crises
but turn negative by the fifth year, potentially indicating a partial
unwinding of banks' sovereign exposure. FDI follows the opposite
pattern, with a larger initial decline in default-linked crises but a
significant recovery by the fifth year -- a rebound possibly
reflecting the IMF-supported financing and adjustment programmes that
typically accompany a restructuring. The difference between crisis
types in both cases is not statistically significant under the
bootstrap test, so these patterns should be read as suggestive rather
than conclusive. Importantly, our analysis is centred on the beginning
of the spread crisis, while the crisis episode itself may last several
years. To determine whether avoiding default leads to a lasting
resolution or simply delays adjustment, future research should examine
outcomes after the end of the spread crisis or restructuring episode.
This would allow post-crisis adjustment to be distinguished from the
dynamics that occur while the crisis is still ongoing.
