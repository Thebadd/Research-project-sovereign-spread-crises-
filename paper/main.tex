...
following crises without default. Finally, for crises without default,
a higher pre-crisis sovereign-bank nexus is associated with a
significantly better GDP response on impact. For crises with default,
by contrast, the point estimate is more negative in the high-nexus
group, although the bootstrap test does not establish a statistically
significant difference between high- and low-nexus countries at any
horizon.
