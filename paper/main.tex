...
more, weights sum to 1):
\[
\text{contagion}_{i,t} = \sum_{k \neq i} w_{ik}\cdot \mathbb{1}[k \text{ in crisis at } t], \qquad w_{ik} = \frac{1/d_{ik}}{\sum_{k'} 1/d_{ik'}}.
\]
The predictor entering the model is this share lagged one year, i.e.
predetermined relative to the crisis onset it predicts.}
\end{table}
