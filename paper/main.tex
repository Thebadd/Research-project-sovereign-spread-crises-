...
\noindent\textbf{Implications:} Our results suggest that the choice to
default or not depends on the nature of the crisis, and on the
trade-off between the cost of continued debt servicing and the cost of
default -- a trade-off also emphasized by \citet{corsetti2013sovereign}
in the context of sovereign risk and fiscal policy. Empirically, spread
crises without default are more strongly associated with external
market conditions, while spread crises with default are more strongly
associated with domestic conditions. One interpretation is that
non-default crises may primarily reflect temporary refinancing
pressures, whereas default-linked crises may reflect more fundamental
debt-sustainability problems. In the former case, avoiding default may
allow the sovereign to preserve market access and benefit from a
recovery in investor confidence. In the latter, delaying restructuring
may prolong uncertainty and elevated financing costs without resolving
the underlying debt problem. We also find that a deeper domestic
banking sector is associated with a lower likelihood of default in the
first place: where domestic financial intermediation is deeper, the
economy can draw more on domestic financing and preserve debt servicing
through alternative adjustment margins, such as inflation or financial
repression -- consistent with \citet{angelini2014negative}'s finding
that the incentive to rely on domestic sovereign debt intensifies where
fiscal positions are weaker -- rather than through default.

In our estimates, spread crises without default are associated with
substantially smaller losses in GDP and domestic private-sector credit
than crises with default. A plausible mechanism is that default
transmits additional costs through the domestic financial system:
restructuring can impose losses on banks' sovereign exposures,
weakening balance sheets and constraining private-sector credit, a
channel also modelled by \citet{mendozayue2012general} through
disrupted access to imported working-capital financing. Consistent
with an anticipation effect, we find that bank claims on government
rise sharply in the year a default-linked crisis begins, suggesting
that banks increase their reliance on the domestic sovereign market in
anticipation of future exclusion from external financing after the
default -- a pattern that echoes \citet{gennaioli2018banks}'s
cross-country evidence that banks tend to increase their government
bond holdings in the run-up to sovereign default.

Investment and FDI, by contrast, do not follow this pattern: both
decline following a spread crisis, but we find no statistically
significant difference between non-default and default-linked crises
at any horizon. This suggests that, unlike GDP and credit, investment
and FDI respond primarily to the uncertainty generated by the spread
crisis itself, rather than to the additional consequences of default.
As emphasised by \citet{krugman1988financing} and \citet{sachs1989debt},
uncertainty about the future debt burden can discourage investment
through expectations of higher future taxation, continued financing
constraints, or the prospect of restructuring, independently of whether
default is ultimately avoided. Avoiding default therefore appears to
limit the additional costs transmitted through the domestic banking
system but does not by itself resolve the uncertainty that continues to
weigh on investment and FDI.
