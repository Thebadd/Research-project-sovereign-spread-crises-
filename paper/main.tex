...
their frequency has risen markedly since the 1990s. \citet{arellano2008default}
shows theoretically that default risk and interest rate spreads are
jointly determined by the state of the economy, with spreads rising
before any default occurs -- the basis for this paper's premise that
elevated spreads are informative of sovereign distress on their own,
independently of whether a formal default follows.
