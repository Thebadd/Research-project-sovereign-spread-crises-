...
for each crisis type \mbox{$S \in \{\text{non-default}, \text{default-linked}\}$},
as follows:
...
\noindent where \mbox{$S \in \{\text{non-default}, \text{default-linked}\}$},
...
each crisis type \mbox{$S \in \{\text{non-default}, \text{default-linked}\}$} and
