...
% D: Bank claims on government) merged into one figure, stacked
% vertically. If this does not fit comfortably on one page, comment out
% this \includegraphics and the two below (fig8_..._part1/part2.png,
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth,height=0.85\textheight,keepaspectratio]{figures/fig8_aipw_nexus_byexposure_all.png}
...
% \begin{figure}[htbp]
% \centering
% \includegraphics[width=0.75\textwidth]{figures/fig8_aipw_nexus_byexposure_part1.png}
% \caption{AIPW estimation by pre-crisis sovereign-bank nexus, non-default or default-linked crises.}
% \label{fig:7}
% \end{figure}
%
...
% \centering
% \ContinuedFloat
% \includegraphics[width=0.75\textwidth]{figures/fig8_aipw_nexus_byexposure_part2.png}
