...
local spec2 "swap l_credit->l_credit_bank | l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open l_credit_bank l_hyperinfl"
local spec3 "drop l_credit                | l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open l_hyperinfl"
local spec4 "drop l_debt l_ca (Asonuma)   | l1_gdpg l_banking_crisis l_govexp l_open l_credit l_hyperinfl"
local spec5 "Asonuma + credit_bank        | l1_gdpg l_banking_crisis l_govexp l_open l_credit_bank l_hyperinfl"
