...
local ctrl_credit      l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open hyperinf_dummy pre_credit
local ctrl_claims_govt $ctrl_core pre_claims_govt
local ctrl_inv         $ctrl_core pre_inv
local ctrl_govexp      l1_gdpg l_debt l_ca l_banking_crisis l_open l_credit hyperinf_dummy pre_govexp
