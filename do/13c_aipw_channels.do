...
* cz_recency in spirit -- see 21_aipw_flow.do's "SECOND PREDICTOR CHANGE"
* section for the diagnostic history. Both terms kept GENERIC (any onset
* type): default-linked-only versions of the contagion and recency terms
* were tested and did not materially improve classification power (see
* 08c_first_stage_table.do's diagnostic history), so cz_def matches cz's
