...
local core_aipw l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open l_credit l_lninfl
...
foreach ch in credit claims_govt inv govexp pb fdi ///
    ...
    * level (credit->l_credit, govexp->l_govexp, ca->ca).
    if      "`ch'" == "credit"            local om l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open l_lninfl pre_credit
    else if "`ch'" == "govexp"            local om l1_gdpg l_debt l_ca l_banking_crisis l_open l_credit l_lninfl pre_govexp
    else if "`ch'" == "ca"                local om l1_gdpg l_debt l_banking_crisis l_govexp l_open l_credit l_lninfl pre_ca
