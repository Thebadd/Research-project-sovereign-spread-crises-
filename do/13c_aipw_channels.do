...
foreach ch in credit claims_govt inv govexp pb fdi ///
    ...
    * level (credit->l_credit, govexp->l_govexp, ca->ca).
    if      "`ch'" == "credit"            local om l1_gdpg l_debt l_ca l_banking_crisis l_govexp l_open hyperinf_dummy pre_credit
    else if "`ch'" == "govexp"            local om l1_gdpg l_debt l_ca l_banking_crisis l_open l_credit hyperinf_dummy pre_govexp
    else if "`ch'" == "ca"                local om l1_gdpg l_debt l_banking_crisis l_govexp l_open l_credit hyperinf_dummy pre_ca
