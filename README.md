...
Sovereign spread crises — episodes in which EMBIG spreads cross extreme thresholds — represent a recurring source of macroeconomic disruption in emerging markets, yet their real output costs and transmission mechanisms remain imprecisely documented. Using a novel dataset of 61 spread crisis episodes across 52 emerging market and frontier economies over 1994–2025, we estimate the output cost of sovereign spread crises and their transmission channels through the local projections method of Jordà (2005), with inverse probability weighting to correct for selection into crisis and into default. We find that spread crises reduce cumulative real GDP per capita by approximately 3.8 percentage points at the trough, with no evidence of mean reversion over a four-year horizon. Strikingly, non-default spread crises — episodes resolved without debt restructuring — still impose a significant output cost of approximately 2.5 percentage points, demonstrating that sovereign stress carries substantial real consequences entirely independent of default. Default-linked episodes amplify this cost by an additional 2 to 3 percentage points.

Decomposing the transmission, we document three main channels. First, private credit contracts persistently following crisis onset, deepening to −3.5 percentage points of GDP at four years — a contraction driven entirely by non-default episodes, in which sustained sovereign risk bleeds into bank lending conditions without the balance sheet relief that restructuring provides. Second, gross investment declines significantly in non-default episodes (trough: −2.7 percentage points at three years), consistent with fiscal crowding-out and heightened uncertainty, while default-linked episodes paradoxically exhibit no significant investment contraction, suggesting that debt restructuring restores investment conditions by removing the sovereign risk overhang. Third, we document a sharp divergence in the sovereign-bank nexus: bank claims on the government surge by 4 to 6 percentage points of GDP in default-linked episodes — a pattern absent in non-default crises and robust to IPW correction (p=0.005) — consistent with the doom-loop mechanism in which undercapitalized banks gamble for resurrection by concentrating sovereign exposure ahead of restructuring. Fiscal policy shows a complementary divergence: non-default governments sustain accommodative expenditure throughout the crisis horizon, while default-linked governments exhibit a boom-bust pattern of initial expansion followed by forced consolidation as market access is lost.

Taken together, these findings challenge two prevailing assumptions. The output cost of sovereign stress does not require default to materialize — the crisis itself is the shock. And default episodes, while more severe in aggregate, do not amplify all channels equally: they avoid the sustained credit and investment contractions that characterize non-default episodes while uniquely activating the sovereign-bank doom loop. The heterogeneity of transmission mechanisms across resolution types has direct implications for crisis management: policies targeting credit supply and investment uncertainty are most relevant for non-default episodes, while financial stability interventions addressing bank sovereign exposure are critical in default trajectories.
